...
pub mod glyphrange_tests {
    ...
    pub fn test_validate_glyphrange_normal() {
        ...
        assert_eq!(validate_glyphrange(s, 5..7),  ByteCharGlyphRange { byte_range: 13..30, char_range: 5..10, glyph_range: 5..7 });
        assert_eq!(validate_glyphrange(s, 2..=3), ByteCharGlyphRange { byte_range: 3..9, char_range: 2..4, glyph_range: 2..4 });
        assert_eq!(validate_glyphrange(s, 4..),   ByteCharGlyphRange { byte_range: 9..30, char_range: 4..10, glyph_range: 4..7 });
        assert_eq!(validate_glyphrange(s, ..),    ByteCharGlyphRange { byte_range: 0..30, char_range: 0..10, glyph_range: 0..7 });
        assert_eq!(validate_glyphrange(s, 3..3),  ByteCharGlyphRange { byte_range: 6..6, char_range: 3..3, glyph_range: 3..3 });     // An empty range is accepted
        assert_eq!(validate_glyphrange(s, 7..7),  ByteCharGlyphRange { byte_range: 30..30, char_range: 10..10, glyph_range: 7..7 }); // An empty range at end position is accepted
        assert_eq!(validate_glyphrange(s, 0..0),  ByteCharGlyphRange { byte_range: 0..0, char_range: 0..0, glyph_range: 0..0 });     // An empty range is accepted ==> crash, return a "normal" range
    }
    ...
    pub fn test_byteslice_from_glyphrange_normal() {
        ...
        assert_eq!(get_byteslice_from_glyphrange(s, 5..), [0xF0, 0x9F, 0x90, 0x97, 0xF0, 0x9F, 0x90, 0xBB, 0xE2, 0x80, 0x8D, 0xE2, 0x9D, 0x84, 0xEF, 0xB8, 0x8F,]);
    ...
    pub fn test_byteslice_from_startglyphcount() {
        let s = "Aé♫山𝄞🐗🐻‍❄️";
        assert_eq!(get_byteslice_from_startglyphcount(s, 4), [0x41, 0xC3, 0xA9, 0xE2, 0x99, 0xAB, 0xE5, 0xB1, 0xB1]);
    }

    #[test]
    pub fn test_byteslice_from_endglyphcount() {
        let s = "Aé♫山𝄞🐗🐻‍❄️";
        assert_eq!(get_byteslice_from_endglyphcount(s, 3), [0xF0, 0x9D, 0x84, 0x9E, 0xF0, 0x9F, 0x90, 0x97, 0xF0, 0x9F, 0x90, 0xBB, 0xE2, 0x80, 0x8D, 0xE2, 0x9D, 0x84, 0xEF, 0xB8, 0x8F]);
    }
...
/*
    ...
    pub fn test_bytevector_from_glyphrange() {
        ...
        assert_eq!(get_bytevector_from_glyphrange(s, ..),   vec![0x41, 0xC3, 0xA9, 0xE2, 0x99, 0xAB, 0xE5, 0xB1, 0xB1, 0xF0, 0x9D, 0x84, 0x9E, 0xF0, 0x9F, 0x90, 0x97, 0xF0, 0x9F, 0x90, 0xBB, 0xE2, 0x80, 0x8D, 0xE2, 0x9D, 0x84, 0xEF, 0xB8, 0x8F,] );
        assert_eq!(get_bytevector_from_glyphrange("", ..),  vec![]);
        assert_eq!(get_bytevector_from_glyphrange(s, 5..),  vec![0xF0, 0x9F, 0x90, 0x97, 0xF0, 0x9F, 0x90, 0xBB, 0xE2, 0x80, 0x8D, 0xE2, 0x9D, 0x84, 0xEF, 0xB8, 0x8F,]);
    ...
    pub fn test_charvector_from_glyphrange() {
        ...
        assert_eq!(get_charvector_from_glyphrange(s, ..),   vec!['A', 'é', '♫', '山', '𝄞', '🐗', '🐻', '\u{200D}', '❄', '\u{FE0F}' ]);
    ...
    pub fn test_glyphvector_from_glyphrange() {
        assert_eq!(
            get_glyphvector_from_glyphrange("e\u{0301}", 0..2),
            vec![Glyph2 {
                byte_range: 0..3,
                char_range: 0..2
            }]
        ...
        assert_eq!(
            get_glyphvector_from_glyphrange("👨‍❤‍👩e\u{0301}🐻‍❄️", 5..7),
            vec![Glyph2 {
                byte_range: 17..20,
                char_range: 5..7
            }]
    ...
    pub fn test_glyphvector_from_glyphrange_panic_end_not_at_glyph_blundary() {
        let _ = get_glyphvector_from_glyphrange("👨‍❤‍👩e\u{0301}🐻‍❄️", 7..9);
    }
    ...
    pub fn test_byteiterator_from_glyphrange() {
        ...
        let mut it = get_byteiterator_from_glyphrange(s, 2..4);
    ...
    pub fn test_chariterator_from_glyphrange() {
        ...
        let mut it = get_chariterator_from_glyphrange(s, 2..=4);
    ...
    pub fn test_glyphiterator_from_glyphrange() {
        let mut it = get_glyphiterator_from_glyphrange("🐻‍❄️e\u{0301}👨🏾‍❤️‍💋‍👨🏻", 4..6);
        assert_eq!(
            it.next(),
            Some(Glyph2 {
                byte_range: 13..16,
    ...
    pub fn test_glyphiterator_from_glyphrange_panic_start_not_at_glyph_boundary() {
        let _ = get_glyphiterator_from_glyphrange("🐻‍❄️e\u{0301}👨🏾‍❤️‍💋‍👨🏻", 3..6);
    }
    ...
    pub fn test_refstr_from_glyphrange() {
        ...
        assert_eq!(get_strref_from_glyphrange(s, 2..=4), "♫山𝄞");
        assert_eq!(get_strref_from_glyphrange(s, 6..6), "");
    }
    ...
    pub fn test_string_from_glyphrange() {
        ...
        assert_eq!(get_string_from_glyphrange(s, 2..5), "♫山𝄞".to_string());
