...
fn t(dp: &DatePatterns, before: &str, expected: &str) {
    ...
    stem = apply_date_transformations(&stem, dp, false, false);
...
fn tests_transformations() {
    ...
    t(&dp, "01Net Hors-Série - N°143 - 03-04.2025" ,"01net HS 143 - 2025-03..04");
    t(&dp, "Science & Vie - 02.2025" ,"Science & Vie - 2025-02");
    t(&dp, "60 Millions de Consommateurs - 02.2025" ,"60M de consommateurs - 2025-02");
    t(&dp, "01Net Hors-Série - N°142 - 01-02.2025" ,"01net HS 142 - 2025-01..02");
    ...
    t(&dp, "Paris Match - HS - N°49 - 02.2025" ,"Paris Match HS 49 - 2025-02");
    ...
    t(&dp, "L’Histoire - HS N.107 - 04-05-06.2025" ,"L'Histoire HS 107 - 2025-04..06");
    ...
    t(&dp, "Que Choisir Hors-Série Budgets - 03.2025" ,"Que Choisir Budgets - 2025-03");
